<template>
    <section>
        <div class="content-container fixed-bg fbc-container">
            <div class="content-wrapper">
                <div class="text-wrapper">
                    <h1>Feline behavior services</h1>
                    <ul>
                        <li>
            ...
            <div class="content-wrapper">
                ...
                <div class="text-wrapper">
                    ...
                    <p class="appointment-call">
                        <strong>Call today for an appointment!</strong> <a href="tel:+13157960907">315-796-0907</a>
                    </p>
                </div>
            </div>
        </div> -->
...
.orange-container .image-wrapper {
    /* height: fit-content; */
    overflow: hidden;
    flex-shrink: 0;
    min-width: 350px;
}
.orange-container .content-wrapper .image-wrapper img {
    width: 350px;
    height: 100%;
    object-fit: cover;
    display: block;
